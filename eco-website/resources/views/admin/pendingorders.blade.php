              ...
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <td class="px-6 py-4">
                        <ul>
                            ...
                            <li>Phone Number : {{$item->shipping_city}}</li>
                            <li>Phone Number : {{$item->shipping_postalcode}}</li>
                        </ul>
                      </td>
                      <td class="px-6 py-4">
                        {{$item->product_id}}
                    ...
                    <td class="px-6 py-4">
                        <form action="{{ route('changestaus', $item->id) }}" method="POST">
                            @csrf
                            
                            <button type="submit"
                                class="focus:outline-none text-white bg-green-400 hover:bg-green-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">
                                Approve Now
                            </button>
                        </form>
                    </td>
