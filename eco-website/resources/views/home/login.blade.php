...
<div class="bg-white dark:bg-gray-900">
    <div class="flex justify-center h-screen">
            ...
            <div class="flex-1">
                <div class="text-center">
                    <h2 class="text-4xl font-bold text-center text-gray-700 dark:text-white">
                        <div class="text-center">
                            <a href="{{route('home')}}" class="text-gray-900 font-bold text-xl">E-commerce <span class="text-blue-400">time</span> </a>
                        </div>
                    </h2>
                ...
                <div class="mt-8">
                    <form method="POST" action="{{ route('buyer.auth') }}">
                        @csrf
                        <div>
        ...
        @endif
                    ...
                    <p class="mt-6 text-sm text-center text-gray-400">Don&#x27;t have an account yet? <a href="{{route('buyer.register')}}" class="text-blue-500 focus:outline-none focus:underline hover:underline">Sign up</a>.</p>
                </div>
            </div>
        </div>
    </div>
